...
INSTALL_DIR				= /Developer/Arduino/Resources
...
$(wildcard $(INSTALL_DIR)/libraries/*/*/*.cpp) \
$(wildcard $(INSTALL_DIR)/libraries/*/*/*/*.cpp) \
$(wildcard $(INSTALL_DIR)/libraries/*/*.h) \
$(wildcard $(INSTALL_DIR)/libraries/*/*/*.h) \
$(wildcard $(INSTALL_DIR)/libraries/*/*/*/*.h)
...
LDFLAGS = -lc -lm -O$(OPT) -Wl,--gc-sections
...
applet/$(TARGET).elf: applet/$(TARGET).o applet/core.a
	$(LD) $(ALL_LDFLAGS) -o $@ applet/$(TARGET).o applet/core.a -lc
